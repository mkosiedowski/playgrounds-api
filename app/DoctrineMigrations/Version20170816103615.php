 ...
 */
class Version20170816103615 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE feature (`key` VARCHAR(255) NOT NULL, name JSON NOT NULL, PRIMARY KEY(`key`)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE playgroundFeature ADD CONSTRAINT FK_697F3B33B4789000 FOREIGN KEY (featureKey) REFERENCES feature (`key`) ON DELETE CASCADE');
    }
